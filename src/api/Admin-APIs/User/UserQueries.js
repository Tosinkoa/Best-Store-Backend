...
export const UserQueries = {
  ...
  selectTodayUserCount(queryPayload) {
    return pool.query(
      "SELECT COUNT(*) AS total_user_count FROM users WHERE role != $1 AND role != $2 AND created_at >= CURRENT_DATE::TIMESTAMP AND created_at < CURRENT_DATE::TIMESTAMP + INTERVAL '1 day'",
      [...queryPayload]
    );
  },
};
